				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:100%; height:300px;'/>
								</div>
								<div class='panel-heading'> $pro_price HUF
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@jestershop.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/jestershop-master/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/jestershop-master/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/jestershop-master/cancel.php"/>
